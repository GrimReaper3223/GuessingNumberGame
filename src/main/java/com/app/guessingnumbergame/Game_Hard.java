...
public class Game_Hard {
    ...
    public Game_Hard() {
        this.random_Hard = new Random();
        this.scan_Hard = new Scanner(System.in);
    }
    
    /**
     * generating a random_Intermediary integer between 0 and 500
     * 
    ...
    public int randomize() {
        ...
        generatedNumber = random_Hard.nextInt(0, 500) + 1;
    ...
    private void scanner() {
        ...
        while(!validData) {
            ...
            try{
                ...
                System.out.print("\nEnter any number from 0 to 500 to guess which number was generated: ");
                receivedUserNumber = scan_Hard.nextInt();
