 ...
 * @version 1.0_BETA;
 * 
 * game mechanics structure based on easy level
...
public class Game_Easy {
    ...
    // instantiating the user mainMenu class, scanner, and random_easy
    private Random random_easy;
    private Scanner scan_easy;
    ...
    public Game_Easy() {
        this.random_easy = new Random();
        this.scan_easy = new Scanner(System.in);
    }
    
    /**
     * generating a random_easy integer between 0 and 100
     * 
    ...
    public int randomize() {
        ...
        generatedNumber = random_easy.nextInt(0, 100) + 1;
    ...
    private void scanner() {
        ...
        while(!validData) {
            ...
            try{
                ...
                System.out.print("\nEnter any number from 0 to 100 to guess which number was generated: ");
                receivedUserNumber = scan_easy.nextInt();

                if(receivedUserNumber > 100) {
